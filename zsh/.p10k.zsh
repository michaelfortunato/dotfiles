# Generated by Powerlevel10k configuration wizard on 2023-08-18 at 12:44 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # FIXME: Do not show python virtual environments, but figure out how to use env var to fix it
